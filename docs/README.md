...
Then launch Foghorn again, or build with `build-signed-dmg.sh` if you have a Developer ID certificate. Details: [docs/RELEASE.md](RELEASE.md#unsigned-dmgs-and-gatekeeper).
